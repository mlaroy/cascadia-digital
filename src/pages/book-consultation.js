    ...
    <Layout>
      ...
      <div className="bg-grey-lightest">
        <Section>
          ...
          {hasJS && (
            <form onSubmit={handleContactSubmit} className="mx-auto max-w-lg" method="post" data-netlify="true" name="book-consultation" data-netlify-honeypot="bot-field" netlify>
